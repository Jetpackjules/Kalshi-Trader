...
if __name__ == "__main__":
    # Try Settlements
    print("--- Attempt 1: /trade-api/v2/portfolio/settlements ---")
    test_endpoint("/trade-api/v2/portfolio/settlements")
    
    # Try Fills (might contain settlements)
    print("\n--- Attempt 2: /trade-api/v2/portfolio/fills ---")
    test_endpoint("/trade-api/v2/portfolio/fills")
